...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Grupo : 301403_5");
    ...
    private void BtnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnIngresarActionPerformed
        ...
        if(TxtUser.getText().equals("Admin") && TxtContraseña.getText().equals("123")){
            Menu exe = new Menu();
            exe.setVisible(true);
            JOptionPane.showMessageDialog(null, "Bievenidos");
            hide();
        }else{
            JOptionPane.showConfirmDialog(null, "Error de usuario", "Error", JOptionPane.WARNING_MESSAGE);
        }
